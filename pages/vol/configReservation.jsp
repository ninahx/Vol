...
<div class="main-content">
    <div class="card">
        ...
        <h2>Configuration des d�lais de r�servation</h2>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary" 
                                            onclick="openConfigModal('<%= vol.getId() %>', '<%= vol.getHeureReservationAvantVol() %>')">
...
<div id="configModal" class="modal">
    <div class="modal-content">
        <h3>Configurer le d�lai de r�servation</h3>
        <form class="form-container" action="<app:url value='/vol/updateHeureReservation' />" method="post">
            <input type="hidden" id="volId" name="id">
            
            <div class="form-group">
                <label for="heureReservationAvantVol">D�lai de r�servation (en heures)</label>
                <input type="number" id="heureReservationAvantVol" name="heureReservationAvantVol" 
                       class="form-control" min="0" required>
                <small class="form-text text-muted">Nombre d'heures minimum avant le vol pour effectuer une r�servation</small>
            </div>
...
function openConfigModal(volId, heures) {
    ...
    document.getElementById('heureReservationAvantVol').value = heures || 0;
